...
export default function ExportStudio({ project, onStatus }: Props) {
  ...
  return (
    <div className="export-studio">
      ...
      <aside className="manual-lms-check"><strong>Trước khi dùng trên K12Online thật</strong><p>Upload ZIP vào tenant thật và kiểm tra launch, resume, completion, success, điểm và session time. Validator tự động không thể thay thế thử nghiệm tenant.</p></aside>
    </div>
  );
}
