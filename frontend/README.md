...
1–7 now use the FastAPI APIs for canonical draft, source, direction, structured
...
SCORM tracking policy and refreshes the same backend player. The FastAPI prototype remains available until each remaining
