"""Create accounts and revocable sessions.
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("school_name", sa.String(length=200)),
    ...
    op.create_foreign_key("fk_projects_owner_user", "projects", "users", ["owner_user_id"], ["id"])
